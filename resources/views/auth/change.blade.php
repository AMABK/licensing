        ...
        <div id="container">
            ...
            <div id="loginbox"style="height: 250px">            
                <form method="post" action="/change-password" accept-charset="utf-8" class="form login-form" id="loginform" >                    
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="password" name="password" value="{{ old('password') }}" id="username" class="form-control" placeholder="New Password" size="60" required="" />                       
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="password" name="password_confirmation"  id="username" class="form-control" placeholder="Confirm Password" size="60" required="" />                       
                    </div>
