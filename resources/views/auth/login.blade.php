...
<html lang="en">
    <head>
        <title>Welcome to PLS | PUBLIC SERVICE VEHICLES’ LICENSING SYSTEM --  By Optimus E-Solutions</title>
            ...
            <div id="loginbox">            
                <form method="post" action="/auth/login" accept-charset="utf-8" class="form login-form" id="loginform" >                    
                    ...
                    <div class="form-actions">
                        <div class="pull-left">
                            <a href="{{URL::to('/password/email')}}" class="flip-link to-recover">Reset password?</a><br />
