...
<html lang="en">
    <head>
        <title>PLS Password Reset | PUBLIC SERVICE VEHICLES’ LICENSING SYSTEM --  By Optimus E-Solutions</title>
            ...
            <div id="loginbox" style="height: 280px">            
                <form method="post" action="/password/reset" accept-charset="utf-8" class="form login-form" id="loginform" >                    
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="Username/Email" size="20" required="" />                       
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="password" name="password" value="{{ old('password') }}" id="password" class="form-control" placeholder="Password" size="60" required="" />                       
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
